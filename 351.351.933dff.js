/*! For license information please see 351.351.933dff.js.LICENSE.txt */
  ...
  [351],
  {
    35443: (e, t, s) => {
      ...
      const c = {
          exit: (e) =>
            n.gsap
              .timeline()
              .fromTo(e, { opacity: 1 }, { opacity: 0, duration: 0.7 }),
          enter: (e) =>
            n.gsap
              .timeline()
              .fromTo(e, { opacity: 0 }, { opacity: 1, duration: 0.7 }),
        },
        l = { exit: () => n.gsap.timeline(), enter: () => n.gsap.timeline() },
        u = a.memo((e) => {
          let { children: t, className: s, animations: n } = e;
          const { currentState: u, finishState: p } = (0, i.SC)(),
            d = (0, a.useRef)(null),
            m = n || c;
          return (
            (0, a.useEffect)(() => {
    ...
    39864: (e, t, s) => {
      ...
      var r = s(85893),
        ...
        l = s(36280);
      const u = (e) => {
        const { dropdownTitle: t, dropdownItems: s, className: u } = e,
          p = (0, a.useRef)(null),
          [d, m] = (0, a.useState)(!1);
        return (
          (0, l.Z)(p, () => m(!1)),
          (0, r.jsxs)("button", {
            ...
            ref: p,
            children: [
              (0, r.jsx)(o.r, { className: "nav-link nav-text", children: t }),
              (0, r.jsx)(n.Q, { src: c, className: "dropdown-icon" }),
              (0, r.jsx)(i.Z, { dropdownItems: s, isActive: d }),
            ],
          })
        );
      };
    ...
    79610: (e, t, s) => {
      ...
      var r = s(85893),
        a = s(39711);
      const n = (e) => {
        const { title: t, linkTo: s, anchorRef: n, onClick: i, href: o } = e,
          c = () => {
            i && i();
          };
        return o
    ...
    95320: (e, t, s) => {
      ...
      var r = s(85893),
        ...
        d = s(77834);
      const m = (e) => {
        const { className: t, dropdownItems: s, isActive: m } = e,
          f = (0, a.useRef)(null),
          g = (0, a.useRef)([]);
        g.current = [];
        const h = m ? "active" : "",
        ...
        (0, a.useEffect)(() => {
          o.gsap.set(f.current, { y: "-150%" }),
            o.gsap.set(g.current, { autoAlpha: 0 });
        }, [g, y]);
        const v = (0, a.useCallback)(() => {
            o.gsap.to(f.current, { y: 0 }),
              o.gsap
                .timeline()
                .fromTo(
                  f.current,
                  { y: "-150%" },
                  { y: 0, duration: (0, p.T)(40), ease: p.V.twoSidedEase },
                  0
                )
                .fromTo(
                  g.current.reverse(),
        ...
        return (
          ...
          (0, r.jsxs)(c.G, {
            ...
            children: [
              ...
              (0, r.jsx)(n.Q, { src: u, className: "dropdown-bg__wrapper" }),
              (0, r.jsx)("ul", {
    ...
    36204: (e, t, s) => {
      ...
      const m = (e) => {
        const {
          ...
          { isDesktop: b } = (0, p.uO)(),
          y = b ? t : t.filter((e) => !e.desktopOnly);
                                  ...
                                  !e.href &&
                                    ...
                                    (0, r.jsxs)(
                                      a.rU,
                                      {
                                        to: e.linkTo,
                                        className:
                                          "button btn-dots-aside inline nav-text",
                                        children: [
                                          e.title,
                                          (0, r.jsx)(n.Q, {
                                            src: u,
                      ...
                      (0, r.jsxs)(i.G, {
                        ...
                        children: [
                          (0, r.jsxs)("form", {
                            target: "_blank",
                            action:
                              "https://static.mailerlite.com/webforms/submit/v5s5u9",
                            method: "post",
    ...
    52764: (e, t, s) => {
      ...
      const c = (0, i.hu)("[Image]"),
        l = o.forwardRef((e, t) => {
          const { children: s, pictureClassName: a, ...n } = e,
            i = n.src.match(/[\w-]+\.(jpg|png|svg)/g),
            c = n.alt || (i && i[0]) || "img",
            l = (0, r.jsx)("img", { ...n, ref: t, alt: c });
          return s && o.Children.count(s) > 0
            ? (0, r.jsxs)("picture", { className: a, children: [s, l] })
            : l;
        }),
        u = o.forwardRef((e, t) => {
      ...
      const l = { autoplay: !0, loop: !0 },
        u = a.forwardRef((e, t) => {
          const {
            ...
            y = {
              className: `button btn-primary ${s || ""} ${g} ${
                h ? "disabled" : ""
              } `,
              href: h ? null : m,
              onClick: h ? null : d,
    ...
    98438: (e, t, s) => {
      ...
      var r = s(85893),
        ...
        g = s(15716);
      const h = (e) => {
          const { title: t, href: s, linkTo: a, goTo: n } = e;
          return (0, r.jsx)("li", {
          ...
          const y = (0, a.useRef)(null),
            ...
            k = (0, a.useCallback)(() => {
              o.default
                ...
                .fromTo(
                  x.current,
                  { y: -80 * _ },
                  { y: 0, ease: d.V.defaultEase, duration: (0, d.T)(60) },
                  (0, d.T)(30)
                )
                .fromTo(
                  v.current,
            ...
            j = (0, a.useCallback)(() => {
              document.body.classList.remove("modal-active"),
                o.default.set(y.current, { opacity: 0, pointerEvents: "none" }),
                o.default.set(x.current, { y: -80 * _ }),
                o.default.set(v.current, { y: 80 * _ }),
                o.default.set(".mobile-menu__link", { opacity: 0 });
            }, [_]),
            T = (0, a.useCallback)(() => {
              o.default
                .timeline({
                ...
                .fromTo(
                  ...
                  { opacity: 1 },
                  {
                    ...
                    duration: (0, d.T)(30),
                    stagger: { from: "end", amount: (0, d.T)(2) },
                  },
                  0
                )
                .fromTo(
                  x.current,
                  { y: 0 },
                  { y: -80 * _, ease: d.V.reverseEase, duration: (0, d.T)(40) },
                  (0, d.T)(10)
                )
                .fromTo(
                  v.current,
          ...
          return (
            ...
            (0, r.jsxs)(i.G, {
              ...
              children: [
                ...
                (0, r.jsx)(i.G, { className: "text-mask top" }),
                (0, r.jsx)(i.G, {
                  className: "container",
                      ...
                      children: [
                        ...
                        t.map((e, t) =>
                          e.dropdownItems
                            ...
                            : (0, r.jsx)(
                                h,
                                { goTo: s, title: e.title, linkTo: e.linkTo },
                                t
                              )
                        ),
                      ],
                ...
                (0, r.jsx)(i.G, { className: "text-mask bot" }),
                (0, r.jsxs)(i.G, {
                  className: "anim-wrap--bot",
                  divRef: v,
                  children: [
                    (0, r.jsx)(n.Q, { src: p, className: "leaves-bot" }),
                    (0, r.jsx)(n.Q, { src: u, className: "grass-bot" }),
                  ],
                }),
              ],
            })
    ...
    90365: (e, t, s) => {
      ...
      const k = (0, n.Pi)((e) => {
              ...
              (0, r.jsxs)(u.G, {
                ...
                children: [
                  (0, r.jsxs)("button", {
                    ...
                    children: [
                      (0, r.jsx)(c.Q, { src: g, className: "icon-bars" }),
                      (0, r.jsx)(c.Q, { src: f, className: "icon-cross" }),
                    ],
                  }),
                  (0, r.jsxs)("div", {
                    className: "right-wrap",
                    children: [
                      (0, r.jsx)(_.c, { isActive: o, onClickCapture: l }),
                      s ? n() : t && (0, r.jsx)(C, { ...t }),
                    ],
                  }),
                ],
              }),
              (0, r.jsx)(h.Z, { links: e.links, isOpen: m, goTo: v }),
            ],
          });
        }),
        j = (0, n.Pi)((e) => {
          ...
          return (0, r.jsxs)(u.G, {
            ...
            children: [
              (0, r.jsxs)(o.rU, {
                ...
                children: [
                  (0, r.jsx)(c.Q, { src: t, className: "navbar-logo" }),
                  f &&
                    (0, r.jsx)(c.Q, {
                      src: p,
              ...
              (0, r.jsxs)("div", {
                className: "right-wrap",
                children: [
                  (0, r.jsx)(_.c, { isActive: g, onClickCapture: h }),
                  d ? m() : n && (0, r.jsx)(C, { ...n }),
                ],
              }),
            ],
        ...
        T = { [b.Ru.Desktop]: p, [b.Ru.Tablet]: d, [b.Ru.Mobile]: m },
        N = (0, n.Pi)((e) => {
          const [t, s] = (0, a.useState)(!1),
            n = (0, a.useRef)(null),
            i = (0, b.HQ)(),
            { isDesktop: o, isMobile: p, isTablet: d, type: m } = (0, b.uO)(),
            f = (0, y.tT)(x.Z),
            {
              isLoggedIn: g,
        ...
        C = (e) => {
          const { linkTo: t, title: s, external: a } = e;
          return a
            ? (0, r.jsx)("a", {
                className: "button btn-secondary btn-2",
                href: t,
        ...
        return (
          ...
          (0, r.jsxs)(i.oW, {
            ...
            children: [
              ...
              a && (0, r.jsx)(c.Z, { isActiveByDefault: m }),
              g && g,
              s &&
                (0, r.jsx)(l.Z, {
    ...
    13406: (e, t, s) => {
      ...
      var r = s(85893);
      function a(e) {
        return e.onKeyPress || e.onEnterPress
          ? e.onEnterPress
            ? function (t) {
                "Enter" === t.key && e.onEnterPress.call(this, t),
                  e.onKeyPress && e.onKeyPress.call(this, t);
              }
            : e.onKeyPress
          : null;
      }
    ...
    85492: (e, t, s) => {
      ...
      const i = (e) => {
          const {
            ...
            m = e.titleClassName,
            f = (e) => {
              let { className: t, src: s, alt: n } = e;
              return l
                ? (0, r.jsx)("img", { className: t, src: s, alt: n })
                : (0, r.jsx)(a.Q, { className: t, src: s, alt: n });
            };
          return (0, r.jsxs)("button", {
            ...
            children: [
              ...
              (0, r.jsxs)(n.r, { className: m, children: [t, e.children] }),
              d &&
                !c &&
                (0, r.jsx)(f, {
                  className: `icon ${u}`,
        ...
        o = (e) => {
          ...
          return (0, r.jsxs)("a", {
            ...u,
            children: [
              p && o && (0, r.jsx)(a.Q, { className: "icon-wrap", src: p.src }),
              (0, r.jsxs)(n.r, { className: d, children: [t, e.children] }),
              p &&
                !o &&
                (0, r.jsx)(a.Q, { className: "icon-wrap", src: p.src }),
            ],
          });
        };
    },
    65388: (e, t, s) => {
      ...
      var r = s(85893),
        ...
        c = s(89301);
      const l = (0, a.Pi)((e) => {
        let { isActive: t, onClickCapture: s } = e;
        return (0, r.jsxs)(n.G, {
          ...
          children: [
            (0, r.jsx)(i.Q, { src: o, className: "sound-button__on-icon" }),
            (0, r.jsx)(i.Q, { src: c, className: "sound-button__off-icon" }),
          ],
        });
      });
    },
    ...
    47346: (e, t, s) => {
      ...
      const i = (e) => {
        ...
        return (
          (0, r.useEffect)(
            () =>
              (0, a.reaction)(() => n.Getter.getValue(e), s, {
                fireImmediately: !0,
              }),
            [e]
          ),
    ...
    43044: (e, t, s) => {
      ...
      const l = a.forwardRef((e, t) => {
        const s = (0, a.useRef)(),
          l = (0, n.Z)(
            (null == t ? void 0 : t.current) || s.current,
            e.path,
            e.config
          ),
          { animation: u, isLoaded: p } = (0, i.x)(l);
        return (
          (0, c.m)(
            e.playing && p,
            (0, a.useCallback)(() => {
            ...
            (0, a.useCallback)(() => (null == u ? void 0 : u.pause()), [u])
          ),
          (0, r.jsxs)(o.G, {
            divRef: t || s,
            ...
            children: [
              e.tempMasks &&
                (0, r.jsx)(o.G, { className: "temp-mask temp-mask--top" }),
              e.children,
              e.tempMasks &&
                (0, r.jsx)(o.G, { className: "temp-mask temp-mask--bot" }),
            ],
          })
        );
      });
    ...
    96470: (e, t, s) => {
      ...
      const m = (e) => {
        const {
          ...
          [k, j] = (0, a.useState)(!1);
        return (0, r.jsxs)(o.G, {
          className: "chumbi-card " + (k ? "flipped" : ""),
          divRef: _,
          onClick: () => {
          ...
          children: [
            (0, r.jsxs)(o.G, {
              ...
              children: [
                (0, r.jsxs)(d.X, {
                  ...
                  children: [
                    (0, r.jsx)("source", { type: "image/webp", srcSet: l }),
                    (0, r.jsx)("source", { type: "image/jpeg", srcSet: c }),
                  ],
                }),
                (0, r.jsxs)(d.X, {
                  priority: 3 | w,
                  ...
                  children: [
                    (0, r.jsx)("source", { type: "image/webp", srcSet: x }),
                    (0, r.jsx)("source", { type: "image/jpeg", srcSet: y }),
                  ],
                }),
                (0, r.jsxs)(d.X, {
                  priority: 3 | w,
                  alt: `${m.charAt(0).toLocaleUpperCase() + m.slice(1)} Chumbi`,
                  className: "frontface__img frontface__img--char",
                  pictureClassName: "picture-frontface__img",
                  children: [
                    (0, r.jsx)("source", { type: "image/webp", srcSet: s }),
                    (0, r.jsx)("source", { type: "image/jpeg", srcSet: t }),
                  ],
                }),
                (0, r.jsx)("h2", {
            ...
            (0, r.jsxs)(o.G, {
              ...
              children: [
                ...
                (0, r.jsx)(o.G, { className: "backface__divider" }),
                (0, r.jsx)("p", {
                  className: "desc-3 backface__desc",
                  style: { color: g || "white" },
                  children: f,
                }),
                e.btnViewMoreDisabled
                  ? null
                  : (0, r.jsx)(i.rU, {
                      to: "/marketplace",
                ...
                (0, r.jsxs)(d.X, {
                  ...
                  children: [
                    (0, r.jsx)("source", { type: "image/webp", srcSet: p }),
                    (0, r.jsx)("source", { type: "image/jpeg", srcSet: u }),
                  ],
                }),
                (0, r.jsxs)(d.X, {
                  priority: w ? w + 1 : 3,
                  ...
                  children: [
                    (0, r.jsx)("source", { type: "image/webp", srcSet: b }),
                    (0, r.jsx)("source", { type: "image/jpeg", srcSet: h }),
                  ],
                }),
              ],
            }),
    ...
    31413: (e, t, s) => {
      ...
      var r = s(85893),
        ...
        i = s(10902);
      const o = (e) => {
        let { children: t, delayMs: s, lazyPriority: o, placeholder: c } = e;
        const [l, u] = (0, a.useState)(!1);
        if (
          ((0, a.useEffect)(() => {
            if ((u(!1), null != o))
              return i.pz.enqueue(async () => {
                u(!0);
              }, o);
            if (null != s) {
              const e = setTimeout(() => {
    ...
    47677: (e, t, s) => {
      ...
      const g = (0, c.Pi)((e) => {
        const [t, s] = (0, a.useState)(!1),
          ...
          b = (0, a.useRef)(null),
          y = (0, a.useRef)(null),
          x = l.default.timeline({ smoothChildTiming: !1 }),
          v = (0, p.HQ)(),
          { isDesktop: w, isTablet: _, isMobile: k } = (0, p.uO)();
        (0, a.useEffect)(() => {
          e.isActiveByDefault && g(!0),
            e.isActiveByDefault
              ? (l.default.set(h.current, {
                  x: k ? "-50%" : 0,
                  left: k ? "50%" : "auto",
                }),
                l.default.set(b.current, { autoAlpha: 1, x: 0 }),
                l.default.set(y.current, { autoAlpha: 0 }))
              : (l.default.set(h.current, { x: (w ? 244 : _ ? 207 : 327) * v }),
                l.default.set(b.current, {
                  autoAlpha: 0,
                  x: (w ? 259 : _ ? 227 : 340) * v,
                }),
                l.default.set(y.current, { autoAlpha: 1 }));
    ...
    21964: (e, t, s) => {
      ...
      var r = s(85893),
        a = s(13406);
      const n = (e) => {
        const { type: t, className: s, style: n } = e;
        return (0, r.jsxs)(a.G, {
          ...
          children: [
            ...
            (0, r.jsx)(a.G, { className: "line-divider__ball" }),
            (0, r.jsx)(a.G, {
    ...
    78041: (e, t, s) => {
      ...
      const l = (e) => {
          ...
          return (0, r.jsxs)(n.G, {
            ...
            children: [
              (0, r.jsxs)(n.G, {
                ...
                children: [
                  (0, r.jsx)("span", { className: "line" }),
                  (0, r.jsx)("span", { className: "small-ball" }),
                  (0, r.jsx)("span", { className: "big-ball" }),
                ],
              }),
              e.children,
              (0, r.jsxs)(n.G, {
        ...
        u = (e) => {
          const t = (0, o.HQ)(),
            { isDesktop: s, isTablet: r, isMobile: n } = (0, o.uO)();
          return (
            (0, a.useEffect)(() => {
              e.current.querySelector(".lines-decoration") &&
                (s &&
                  (i.default.set(e.current.querySelector(".line-before"), {
                    autoAlpha: 0,
                  }),
                  ...
                  i.default.set(
                    e.current.querySelector(".line-before .small-ball"),
                    { x: -154 * t }
                  ),
                  i.default.set(
                    e.current.querySelector(".line-before .big-ball"),
                    { x: -173 * t }
                  ),
                  ...
                  i.default.set(
                    e.current.querySelector(".line-after .small-ball"),
                    { x: 154 * t }
                  ),
                  i.default.set(
                    e.current.querySelector(".line-after .big-ball"),
                    { x: 173 * t }
                  )),
                r &&
                  (i.default.set(e.current.querySelector(".line-before"), {
            ...
            {
              animateLines: (0, a.useCallback)(
                (t) =>
                  i.default
                    .timeline()
                    .to(
                      e.current.querySelector(".line-before"),
                      {
                        autoAlpha: 1,
                        duration: (0, c.T)(40),
                    ...
                    .to(
                      e.current.querySelector(".line-before .line"),
                      { x: 0, duration: (0, c.T)(60), ease: c.V.defaultEase },
                      t + 0
                    )
                    .to(
                      e.current.querySelector(".line-before .big-ball"),
                    ...
                    .to(
                      e.current.querySelector(".line-before .small-ball"),
                      { x: 0, duration: (0, c.T)(54), ease: c.V.defaultEase },
                      t + (0, c.T)(11)
                    )
                    .to(
                      e.current.querySelector(".line-after"),
                      {
                        autoAlpha: 1,
                        duration: (0, c.T)(40),
                        ease: c.V.defaultEase,
                    ...
                    .to(
                      e.current.querySelector(".line-after .line"),
                      { x: 0, duration: (0, c.T)(60), ease: c.V.defaultEase },
                      t + 0
                    )
                    .to(
      ...
      const k = {
        ...
        j = (e) => {
          const t = (0, a.useRef)(null),
            ...
            N = (0, a.useRef)(null),
            C = (0, a.useRef)(null),
            { isDesktop: S, isTablet: E, isMobile: A } = (0, p.uO)(),
            O = (0, p.HQ)(),
          ...
          return (
            (0, a.useEffect)(() => {
              const e = new c.C(s.current, {
                ...
                r = e.chars;
              m.default.set(r, { autoAlpha: 0, y: 15 * O }),
                m.default.set(j.current.querySelectorAll(".desc-2"), {
                  y: 50 * O,
                  autoAlpha: 0,
                }),
                m.default.set(C.current, { scale: 1.2 }),
                S &&
                  (m.default.set(t.current.querySelector(".line-before"), {
                    autoAlpha: 0,
                  }),
                  ...
                  m.default.set(
                    t.current.querySelector(".line-before .small-ball"),
                    { x: -154 * O }
                  ),
                  m.default.set(
                    t.current.querySelector(".line-before .big-ball"),
                    { x: -173 * O }
                  ),
                  ...
                  m.default.set(
                    t.current.querySelector(".line-after .small-ball"),
                    { x: 154 * O }
                  ),
                  m.default.set(
                    t.current.querySelector(".line-after .big-ball"),
                    { x: 173 * O }
                  ),
                  m.default.set(T.current, { y: 220 * O }),
                  m.default.set(N.current, { y: -233 * O })),
                E &&
                  (m.default.set(t.current.querySelector(".line-before"), {
                    autoAlpha: 0,
                  }),
                  ...
                  m.default.set(T.current, { y: 115 * O }),
                  m.default.set(N.current, { y: -116 * O })),
                A &&
                  (m.default.set(t.current.querySelector(".line-before"), {
                    autoAlpha: 0,
                  }),
                  ...
                  m.default.set(T.current, { y: 61 * O }),
                  m.default.set(N.current, { y: -57 * O }));
              const a = o.i.create({
                once: !0,
                trigger: t.current,
                ...
                onEnter: () => {
                  m.default.to(t.current.querySelector(".line-before"), {
                    ...
                    m.default.to(
                      t.current.querySelector(".line-before .line"),
                      { x: 0, duration: (0, l.T)(60), ease: l.V.defaultEase }
                    ),
                    m.default.to(
                      t.current.querySelector(".line-before .big-ball"),
                      { x: 0, duration: (0, l.T)(60), ease: l.V.defaultEase }
                  ...
                  children: (0, r.jsxs)(n.G, {
                    ...
                    children: [
                      (0, r.jsx)(i.f, {
                        ...
                        children: (0, r.jsx)("h1", {
                          className:
                            "about-section__content__title title-h1 center-text",
                          ref: s,
                          children: "About",
                        }),
                      }),
                      (0, r.jsx)("p", {
                        className:
                          "about-section__content__text desc-2 center-text",
                        ref: j,
                        children: S
                          ? k.desktop.map((e, t) =>
                              (0, r.jsx)(
    ...
    14468: (e, t, s) => {
      ...
      const b = {
          ...
          gap: "0.35rem",
          arrowPath:
            "M18.9442 10L29 20L18.9442 30L16.2559 27.2723L21.6389 21.9191H11V18.0809H21.6389L16.2559 12.7277L18.9442 10Z",
        ...
        y = {
          ...
          mobile: [
            "mystical, elemental NFT creatures",
        ...
        x = (e) => {
          const {
            ...
            T = (0, a.useRef)(null),
            N = (0, u.HQ)(),
            C = (0, a.useMemo)(() => new m.ku("CARD SECTION"), []),
            { isDesktop: S, isTablet: E, isMobile: A } = (0, u.uO)(),
            { Splide: O, SplideSlide: R } = (0, h.a)(() => d.W.value) || {};
          return (
            (0, a.useEffect)(() => {
              ...
              S
                ? (i.default.set(r, { y: 50 * N, autoAlpha: 0 }),
                  i.default.set(k.current, { y: 50 * N, autoAlpha: 0 }))
                : (i.default.set(r, { y: 30 * N, autoAlpha: 0 }),
                  i.default.set(k.current, { y: 30 * N, autoAlpha: 0 })),
                i.default.set(s, { autoAlpha: 0, y: 15 * N });
              const a = i.default.utils.toArray(".splide__slide").slice(0, 3);
              i.default.set(a, { y: 240 * N });
              const n = o.i.create({
                once: !0,
                trigger: w.current,
                ...
                onEnter: () => {
                  ...
                  const t =
                    null === (e = j.current) || void 0 === e
                      ? void 0
                      : e.splide.Components.Arrows.arrows;
                  S
                    ? (i.default.set(t.prev, { y: 50 * N, autoAlpha: 0 }),
                      i.default.set(t.next, { y: 50 * N, autoAlpha: 0 }))
                    : (i.default.set(t.prev, { y: 30 * N, autoAlpha: 0 }),
                      i.default.set(t.next, { y: 30 * N, autoAlpha: 0 })),
                    i.default.to(s, {
                      y: 0,
                      duration: (0, p.T)(60),
                      stagger: (0, p.T)(1),
      ...
      const H = {
        ...
        Q = (e) => {
          const t = (0, a.useRef)(null),
            ...
            X = (0, a.useRef)(null),
            Y = (0, a.useRef)(null),
            { isDesktop: K, isTablet: J, type: ee } = (0, p.uO)(),
            te = (0, p.HQ)();
          return (
            (0, a.useEffect)(() => {
              const e = K ? -160 : J ? -80 : -40,
                ...
                a = { duration: 1.5, force3D: !1, overwrite: !0 };
              return (
                r
                  .to(Y.current, { y: 500 * te, ...a }, 0)
                  .to(z.current, { y: e * te, ...a }, 0)
                  .to(X.current, { y: s * te, ...a }, 0),
                () => {
                  r.kill();
                }
              );
            ...
            (0, r.jsxs)(c.G, {
              ...
              children: [
                (0, r.jsxs)(c.G, {
                  ...
                  children: [
                    (0, r.jsx)(o.Q, { src: _, className: "creepers" }),
                    (0, r.jsxs)(i.X, {
                      priority: null == e ? void 0 : e.loadingPrio,
                      alt: "Sky",
                      className: "sky",
                    ...
                    (0, r.jsxs)(c.G, {
                      className:
                        "community-section__contents center-text parallax-item",
                      divRef: Y,
                      children: [
                        (0, r.jsx)("h2", {
                          className:
        ...
        return (
          (0, a.useEffect)(() => {
            const e = new l.C(y.current, {
              ...
              r = s.chars;
            o.default.set(t, { autoAlpha: 0, y: 15 * w }),
              o.default.set(x.current, { autoAlpha: 0 }),
              o.default.set(r, { y: 15 * w, autoAlpha: 0 });
            const a = c.i.create({
              trigger: h.current,
  ...
  ,
        ...
        b = (e) => {
          ...
          const w = (e) => {
            ...
            _ = (0, d.HQ)(),
            { isDesktop: k, isTablet: j, isMobile: T } = (0, d.uO)(),
            N = (0, a.useMemo)(() => new m.ku("GAMEPLAY FEATURES"), []);
          return (
            (0, a.useEffect)(() => {
              if (!k) return;
              const e = o.gsap.utils.toArray(
                  t.current.querySelectorAll(".text-block")
                ),
                s = o.gsap.utils.toArray(".gameplay-image"),
                r = o.gsap.timeline({ smoothChildTiming: !0 });
              e.forEach((e, t) => {
                const r = e.querySelector(".text-block__title"),
                  ...
                  n = c.i.create({
                    ...
                    start: () =>
                      ...
                      0 === t
                        ? `bottom+=${80 * _} top+=${400 * _}`
                        : `bottom+=${180 * _} top+=${400 * _}`,
                    onEnter: () => {
                      o.gsap.to([r, a], {
                        color: "white",
                        duration: 1,
            ...
            (0, a.useEffect)(() => {
              ...
              o.gsap.set(t.current.querySelectorAll(".gameplay-image")[0], {
                ...
                o.gsap.set(r, { autoAlpha: 0, y: 15 * _ }),
            ...
            (0, a.useEffect)(() => {
              ...
              o.gsap.set(n, { scale: 1.2, autoAlpha: 1 }),
                o.gsap.set(r, { autoAlpha: 0, y: 15 * _ }),
                o.gsap.set(a, { autoAlpha: 0, y: 50 * _ });
              const u = c.i.create({
                trigger: t.current,
                endTrigger: t.current,
                start: "top center",
              ...
              return (
                ...
                i.forEach((e, t) => {
                  const s = e.querySelector(".gameplay-feature__image"),
                    ...
                    n = a.chars,
                    i = Array.from(
                      e.querySelectorAll(".gameplay-feature__desc")
                    );
                  o.gsap.set(i, { color: "#305b3f", y: 30 * _, autoAlpha: 1 }),
                    o.gsap.set(n, { autoAlpha: 0, y: 15 * _ });
                  const u = c.i.create({
                    ...
                    (0, r.jsxs)(n.G, {
                      ...
                      children: [
                        (0, r.jsx)(n.G, {
                          ...
                          divRef: x,
                          children: u.h.gameplaySectionList.map((t, s) =>
                            (0, r.jsxs)(
                              i.X,
                              {
                                priority: e.loadingPrio,
                                alt: null == t ? void 0 : t.imgAlt,
                                className: `gameplay-image gameplay-image-${
                                  s + 1
                                }`,
                        ...
                        (0, r.jsx)(n.G, {
                          className: "text-wrap",
                          children: u.h.gameplaySectionList.map((e, t) =>
                            (0, r.jsxs)(
                              "div",
                              {
                                ...
                                children: [
                                  (0, r.jsx)("h2", {
                                    className:
                                      "title-h2 text-block__title anim-text",
                                    children: e.title,
                                  }),
                                  (0, r.jsx)("p", {
                                    className:
                                      "desc-2 text-block__desc anim-text",
                    ...
                    (0, r.jsx)(n.G, {
                      ...
                      children: u.h.gameplaySectionList.map((t, s) =>
                        (0, r.jsxs)(
                          n.G,
                          {
                            className: `gameplay-feature gameplay-feature-${
                              s + 1
                            }`,
                            children: [
                              (0, r.jsx)(n.G, {
                                ...
                                children: (0, r.jsxs)(
                                  ...
                                  {
                                    priority:
                                      null == e ? void 0 : e.loadingPrio,
                                    alt: `Gameplay: ${t.title}`,
                                    className: `gameplay-feature__image gameplay-feature__image-${
                                      s + 1
                                    }`,
                                    children: [
                                      t.imgSrcWebp &&
                              ...
                              (0, r.jsxs)(n.G, {
                                ...
                                children: [
                                  (0, r.jsx)("h2", {
                                    className:
                                      "title-h2 gameplay-feature__title",
                                    children: t.title,
                                  }),
                                  j &&
                                    t.desc.tablet.map((e, t) =>
                                      (0, r.jsx)(
                                        "p",
                                        {
                                          className:
                                            "desc-2 gameplay-feature__desc",
                                          children: e,
                                        },
                                        t
                                      )
    ...
    75629: (e, t, s) => {
      ...
      var r = s(85893),
        ...
        H = s(29482),
        U = s(9190);
      const Q = ["twitter", "discord", "telegram"],
        W = { [l.Ru.Desktop]: _, [l.Ru.Tablet]: Z, [l.Ru.Mobile]: F },
        z = () => {
          const e = (0, a.useRef)(null),
            t = (0, a.useRef)(null),
            s = (0, a.useRef)(null),
            _ = (0, a.useRef)(null),
            { isDesktop: Z, isTablet: F, isMobile: z, type: X } = (0, l.uO)(),
            Y = (0, l.HQ)(),
            K = W[X];
          return (
            (0, a.useEffect)(() => {
              const r = z ? 250 : 500,
                ...
                u = { duration: 3, force3D: !1, overwrite: !0 };
              return (
                l
                  .to(s.current, { y: r * Y, ...u }, 0)
                  .to(
                    t.current.querySelector(".parallax-item.mountains"),
                    { y: n * Y, ...u },
                    0
                  )
                  .to(
                    t.current.querySelector(".parallax-item.cliff"),
                    { y: i * Y, ...u },
                    0
                  )
                  .to(
                    t.current.querySelector(".parallax-item.forest"),
                    { y: o * Y, ...u },
                    0
                  )
                  .to(
                    e.current.querySelector(".parallax-item.grass"),
                    { y: -a * Y, ...u },
                    0
                  )
                  .to(
                    e.current.querySelector(".parallax-item.rocks"),
                    { y: -40 * Y, ...u },
                    0
                  ),
                () => {
            ...
            (0, r.jsxs)(i.G, {
              ...
              divRef: e,
              children: [
                (0, r.jsx)(n.Q, { src: K, className: "palms-top" }),
                (0, r.jsxs)(i.G, {
    ...
    89941: (e, t, s) => {
      ...
      var r = s(85893),
        ...
        m = s(79632),
        f = s(31413);
      const g = { loop: !1, autoplay: !1, renderer: "canvas" },
        h = () => {
          const [e, t] = (0, a.useState)(!1),
            ...
            x = (0, a.useRef)(null),
            v = (0, p.HQ)(),
            { isDesktop: w, isTablet: _ } = (0, p.uO)();
          return (
            (0, a.useEffect)(() => {
              h(w ? o : _ ? c : l);
            }, [w, _]),
            (0, a.useEffect)(() => {
              i.default.set(y.current, { y: 20 * v, autoAlpha: 0 }),
                i.default.set(x.current, { y: -20 * v, autoAlpha: 0 });
              const e = u.i.create({
                trigger: b.current,
                  ...
                  children: (0, r.jsxs)(n.G, {
                    ...
                    children: [
                      (0, r.jsx)("h2", {
                        ...
                        ref: y,
                        children: "Infinite Combinations",
                      }),
                      (0, r.jsx)("p", {
                        className:
        ...
        T = (e) => {
          ...
          return (
            (0, a.useEffect)(() => {
              ...
              L
                ? (o.default.set(C.current, { y: 115 * P }),
                  o.default.set(S.current, { y: -108 * P }))
                : V
                ? (o.default.set(C.current, { y: 60 * P }),
                  o.default.set(S.current, { y: -60 * P }))
                : (o.default.set(C.current, { y: 29 * P }),
                  o.default.set(S.current, { y: -24 * P })),
                o.default.set(E.current, { scale: 1.2 }),
                o.default.set(s.current, { y: 15 * P, autoAlpha: 0 }),
                o.default.set(r, { y: 15 * P, autoAlpha: 0 }),
                o.default.set(i, { y: 50 * P, autoAlpha: 0 }),
                o.default.set(A.current, { autoAlpha: 0 }),
                o.default.set(n, { y: 15 * P, autoAlpha: 0 });
              const u = c.i.create({
                trigger: t.current,
                endTrigger: t.current,
                      ...
                      (0, r.jsxs)(n.G, {
                        ...
                        children: [
                          (0, r.jsx)("p", {
                            ...
                            children: j[R.name.toLocaleLowerCase()].p1.map(
                              (e, t) =>
                                (0, r.jsx)(
                                  i.r,
                                  {
                          ...
                          (0, r.jsx)("p", {
                            className: "token-section__desc desc-1",
                            children: j[R.name.toLocaleLowerCase()].p2.map(
                              (e, t) =>
                                (0, r.jsx)(
                                  i.r,
                                  {
    ...
    5143: (e, t, s) => {
      ...
      const n = a.Z.create("default", "0.17, 0.17, 0.45, 1.00"),
        ...
        l = a.Z.create(
          "bouncy",
          "M0,0 C0,0 0.23,0.136 0.326,0.382 0.421,0.625 0.462,1.238 0.608,1.238 0.678,1.238 0.764,1.01 1,1 1.034,0.998 1,1 1,1 "
        ),
        u = {
          defaultEase: n,
          reverseEase: i,
    ...
    95351: (e, t, s) => {
      "use strict";
      s.r(t), s.d(t, { HomePage: () => b, default: () => y });
      var r = s(85893),
        a = s(67294),
        n = s(15293),
        i = s(75629),
      ...
      const b = a.memo(() => {
          ...
          return (0, r.jsxs)(n.Z, {
            ...
            children: [
              ...
              (0, r.jsx)(u.Z, {}),
              (0, r.jsx)(p.Z, { loadingPrio: 3, btnViewMoreDisabled: !0 }),
              (0, r.jsx)(d.Z, { loadingPrio: 4 }),
              (0, r.jsx)(l.Z, { loadingPrio: 6 }),
            ],
          });
        }),
        y = b;
      ...
      !(function (e) {
        ...
        (e.getValue = (e, t) => {
          ...
          (function (e) {
            (e.Opacity = {
              init: (e) => {
                a.default.set(e, { autoAlpha: 0 });
              },
              finished: (e) => {
                a.default.fromTo(e, { autoAlpha: 0 }, { autoAlpha: 1 });
              },
            }),
              (e.NoOp = {});
          })((t = e.Hooks || (e.Hooks = {}))),
    ...
    88766: (e, t, s) => {
      ...
      const c = [r.chumbi, r.eth],
        l = "marketplace-currency";
      class u {
        constructor() {
          (this.currencySelect = new a.SelectString(c, (0, o.B)(l, c))),
            (0, n.reaction)(
    ...
    96522: (e, t, s) => {
      ...
      class o {
        ...
        get mode() {
          return n.log({ initializing: !1 }), i.Default;
        }
      ...
      (0, r.gn)(
        [a.observable.ref, (0, r.w6)("design:type", Object)],
        o.prototype,
        "_navigationState",
        void 0
      ),
        ...
        (0, r.gn)(
          [
            ...
            (0, r.w6)("design:paramtypes", [Object]),
    ...
    52842: (e, t, s) => {
      ...
      class i {
        constructor() {
          (this._isLoggedIn = n.Z.Instance.isLoggedIn),
            (this._isSoundActive = n.Z.Instance.isSoundActive),
            (this.onClickConnect = () => {
        ...
        get connectBtn() {
          return { title: "connect", onClick: this.onClickConnect };
        }
        get marketplaceDropdown() {
          return {
            ...
            dropdownItems: [
              ...
              { title: "Log Out", linkTo: null, onClick: this.onClickLogOut },
            ],
          };
        }
      }
    ...
    11209: (e, t, s) => {
      ...
      class p {
        constructor() {
          (this._isLoggedIn = new o.FlagModel(a.ZP.hasValue(u))),
            (this._disposer = new n.ku()),
            (this._router = new l.r()),
            (this.currency = (0, r.createLazy)(() => new c.Z())),
            (this._isSoundActive = new o.FlagModel(!1)),
            this._disposer.add(
              (0, i.reaction)(
                () => p.Instance.isLoggedIn.value,
                (e) => {
        ...
        static Destroy() {
          p._instance.hasValue &&
            (p._instance.value.dispose(), p._instance.reset());
        }
        get isLoggedIn() {
      ...
      function n(e, i) {
        ...
        if (e && i && "object" == typeof e && "object" == typeof i) {
          ...
          if (Array.isArray(e)) {
            ...
            for (c = o; 0 != c--; ) if (!n(e[c], i[c])) return !1;
            return !0;
          }
          ...
          if (a && ArrayBuffer.isView(e) && ArrayBuffer.isView(i)) {
            if ((o = e.length) != i.length) return !1;
            for (c = o; 0 != c--; ) if (e[c] !== i[c]) return !1;
            return !0;
          }
          ...
          if ((o = (l = Object.keys(e)).length) !== Object.keys(i).length)
            return !1;
          for (c = o; 0 != c--; )
    ...
    64593: (e, t, s) => {
      ...
      var r,
        ...
        $ = function (e, t, s) {
          ...
          return s
            ...
            .reduce(function (e, s) {
              ...
              s.filter(function (e) {
                for (
                  var s = void 0, n = Object.keys(e), i = 0;
                  i < n.length;
                  i++
                ) {
                  var o = n[i],
        ...
        X = function (e, t) {
          void 0 !== e && document.title !== e && (document.title = z(e)),
            Y(y.TITLE, t);
        },
        Y = function (e, t) {
          ...
          if (s) {
            for (
              ...
              var c = i[o],
                l = t[c] || "";
              s.getAttribute(c) !== l && s.setAttribute(c, l),
            ...
            a.length === n.length
              ? s.removeAttribute(S)
              : s.getAttribute(S) !== i.join(",") &&
                s.setAttribute(S, i.join(","));
          }
        },
        K = function (e, t) {
        ...
        se = function (e) {
          ...
          return {
            ...
            title: te(y.TITLE, { title: p, titleAttributes: d }, r),
          };
        },
        re = u()(
          function (e) {
              ...
              return (
                ...
                (t.prototype.flattenArrayTypeChildren = function (e) {
                  ...
                  return R(
                    {},
                    r,
                    (((t = {})[s.type] = [].concat(r[s.type] || [], [
                      R({}, a, this.mapNestedChildrenToProps(s, n)),
                    ])),
                    t)
                  );
                }),
                  ...
                  switch (r.type) {
                    case y.TITLE:
                      return R(
                        ...
                        a,
                        (((t = {})[r.type] = i),
                        (t.titleAttributes = R({}, n)),
                        t)
                      );
                    case y.BODY:
                      return R({}, a, { bodyAttributes: R({}, n) });
                    case y.HTML:
                      return R({}, a, { htmlAttributes: R({}, n) });
                  }
    ...
    17695: (e, t, s) => {
      var r = { "./chumbi-valley-og.jpg": 78503 };
      function a(e) {
        var t = n(e);
        return s(t);
      }
    ...
    88837: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/main-logo.a9402e.png";
    },
    14496: (e, t, s) => {
      "use strict";
    ...
    32734: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/cave-char.24d7ed.png";
    },
    51103: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/cave-char.825315.webp";
    },
    96160: (e, t, s) => {
      "use strict";
    ...
    43055: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/flame-char.87ab12.png";
    },
    63235: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/flame-char.1424ca.webp";
    },
    91115: (e, t, s) => {
      "use strict";
    ...
    84953: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/forest-char.47d736.png";
    },
    64223: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/forest-char.a6650e.webp";
    },
    62177: (e, t, s) => {
      "use strict";
    ...
    40768: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/river-char.bca196.png";
    },
    35229: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/river-char.1db575.webp";
    },
    64529: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/spark-char.8225c0.png";
    },
    98923: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/spark-char.109d0f.webp";
    },
    62622: (e, t, s) => {
      "use strict";
    ...
    78927: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/chumbi.2c45ad.png";
    },
    68569: (e, t, s) => {
      "use strict";
    ...
    28200: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/1.610c19.webp";
    },
    45380: (e, t, s) => {
      "use strict";
    ...
    82385: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/2.f285ca.webp";
    },
    95077: (e, t, s) => {
      "use strict";
    ...
    65193: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/4.1e07a4.webp";
    },
    49412: (e, t, s) => {
      "use strict";
    ...
    50802: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/5.0db6da.webp";
    },
    41500: (e, t, s) => {
      "use strict";
    ...
    96959: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/01_mob@2.ed1b5f.webp";
    },
    80509: (e, t, s) => {
      "use strict";
    ...
    9708: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/02_mob@2.8ae92a.webp";
    },
    16664: (e, t, s) => {
      "use strict";
    ...
    65399: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/04_mob@2.749ded.webp";
    },
    52944: (e, t, s) => {
      "use strict";
    ...
    70676: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/05_mob@2.bda069.webp";
    },
    88729: (e, t, s) => {
      "use strict";
    ...
    86365: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/01_tab@2.a02eba.webp";
    },
    23771: (e, t, s) => {
      "use strict";
    ...
    454: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/02_tab@2.217754.webp";
    },
    75868: (e, t, s) => {
      "use strict";
    ...
    39237: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/04_tab@2.ff69ed.webp";
    },
    65418: (e, t, s) => {
      "use strict";
    ...
    78503: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/chumbi-valley-og.7ef3b2.jpg";
    },
    19399: (e, t, s) => {
      "use strict";
    ...
    96097: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/01_tokens_des@2.2eb240.jpg";
    },
    83482: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/01_tokens_des@2.4bf5d3.webp";
    },
    61379: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/01_tokens_mob@2.43efea.jpg";
    },
    61298: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/01_tokens_mob@2.01ba05.webp";
    },
    32176: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/01_tokens_tab@2.6bcdbb.jpg";
    },
    15686: (e, t, s) => {
      "use strict";
      e.exports = s.p + "assets/img/01_tokens_tab@2.415ff8.webp";
    },
    87942: (e, t, s) => {
      "use strict";
      e.exports =
        s.p +
        "assets/lottie/infinityChumbiDesktop/InfinityChumbiLottie__desktop.10cce7.json";
    },
    61803: (e, t, s) => {
      "use strict";
      e.exports =
        s.p +
        "assets/lottie/infinityChumbiMobile/InfinityChumbiLottie__mobile.17fffd.json";
    },
    51074: (e, t, s) => {
      "use strict";
      e.exports =
        s.p +
        "assets/lottie/infinityChumbiTablet/InfinityChumbiLottie__tablet.feb238.json";
    },
    12486: (e, t, s) => {
      "use strict";
    ...
    61628: (e, t, s) => {
      "use strict";
      e.exports =
        s.p + "assets/lottie/mainBtnWide/mainBtnWideLottie.66bfd5.json";
    },
  },
]);
//# sourceMappingURL=351.351.933dff.js.map
